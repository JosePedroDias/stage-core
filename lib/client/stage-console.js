...
(function() {
    ...
    var console = {
        ...
        _onConsoleCommand: function(cmd) {
            window.console.log('SEND', cmd);
            window.stage.send('message', cmd);
        },
    ...
    window.stage.subscribe('message', window.stage.console.writeLine.bind(console));
